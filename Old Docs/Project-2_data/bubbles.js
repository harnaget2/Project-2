...
function changeYear(year){
	var CSV2015 = 'data2015.csv';
	var CSV2014 = 'data2014.csv';
	if (year === '2015'){
...
var padding = 3;
 ...
 function draw(varname) {
  ...
  .attr("text-anchor", "middle")
  .text(function(d) { return d.objectName; });
  ...
  function showPopover(d) {
    $(this).popover({
      ...
      html: true,
      content: function() {
        return "State: " + d.objectName + "</br>Total Fatalities: " + d.crashes + "</br>Risk Category 2: " + d.riskCategory2;
      }
    });
    $(this).popover('show');
  }
